...
import java.util.*;
import sarf.*;
import sarf.noun.trilateral.unaugmented.assimilate.AssimilateAdjectiveFormula;
...
//        String formulaClassName = getClass().getPackage().getName() + ".nonstandard.NounFormula" + formulaID;
        String formulaClassName = "sarf.noun.trilateral.unaugmented.assimilate" + ".nonstandard.NounFormula" + formulaID;
