...
import java.util.*;
import sarf.*;
import sarf.noun.trilateral.unaugmented.instrumental.NonStandardInstrumentalNounFormula;
import sarf.noun.trilateral.unaugmented.instrumental.XmlNonStandardInstrumentalNounFormula;
...
//            String formulaClassName = getClass().getPackage().getName() + ".nonstandard.NounFormula" + i;
            String formulaClassName = "sarf.noun.trilateral.unaugmented.instrumental" + ".nonstandard.NounFormula" + i;
