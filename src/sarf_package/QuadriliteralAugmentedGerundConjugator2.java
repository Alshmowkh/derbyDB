 ...
 * @version 1.0
 */
public class QuadriliteralAugmentedGerundConjugator2 {

    private static QuadriliteralAugmentedGerundConjugator2 instance = new QuadriliteralAugmentedGerundConjugator2();
    private Map gerundClassMap = new HashMap();

    private int[] indexArray = {1, 3, 6, 7, 9, 12, 13, 15, 18};

    private QuadriliteralAugmentedGerundConjugator2() {
        for (int i = 1; i <= 3; i++) {
            String gerundClassName = "sarf.gerund.quadrilateral.augmented.pattern.GerundPattern" + i;
            try {
    ...
    public static QuadriliteralAugmentedGerundConjugator2 getInstance() {
        return instance;
    }

    public List createGerundList(AugmentedQuadriliteralRoot root, int formulaNo) {
        String gerundPatternClassName = "sarf.gerund.quadrilateral.augmented.pattern.GerundPattern" + formulaNo;
