...
import sarf.noun.trilateral.unaugmented.timeandplace.XmlTimeAndPlaceNounFormula;
...
//            String formulaClassName = getClass().getPackage().getName()+".nonstandard.NounFormula"+i;
            String formulaClassName = "sarf.noun.trilateral.unaugmented.timeandplace" + ".nonstandard.NounFormula" + i;
...
//            JOptionPane.showMessageDialog(null, formulaClassNamesMap.get(formulaName));
