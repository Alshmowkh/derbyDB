...
//            String gerundClassName = getClass().getPackage().getName() + ".pattern." + "GerundPattern" + i;
            String gerundClassName = "sarf.gerund.trilateral.augmented.nomen.pattern.GerundPattern" + i;
            try {
...
//        String gerundPatternClassName = getClass().getPackage().getName() + ".pattern." + "GerundPattern" + formulaNo;
        String gerundPatternClassName = "sarf.gerund.trilateral.augmented.nomen.pattern.GerundPattern" + formulaNo;
